...
#define PICC_AUTHENT1A        0x60               //验证秘钥A
#define PICC_AUTHENT1B        0x61               //验证秘钥B
...
/***********************RC522函数宏定义**********************/
#define          RC522_CS_Enable()         GPIO_ResetBits ( GPIOA, GPIO_Pin_4 )    //模块上的sda引脚即为其片选输入端
...
void ShowID(u16 x,u16 y, u8 *p, u16 charColor, u16 bkColor);     //以十六进制显示卡号
